...
git add     → **kya bhejna hai select karo**  **git add .**

git commit  → **local me save karo          git commit -m "message"**

git push    → **GitHub par bhejo**

git pull    → **GitHub se lao**

git restore → **galti undo karo              git restore . *to restore the file from the local to local * 

git Ls   to know which folder are you currently working / know the current folder name 

git branch **To know your branch**

PWD **To know which file are you present**
...
git push -u origin [your-current-branch-name] **To connect main branch with github main branch**
